...
fun PaymentScreen(
    ...
    BottomSheetScaffold(scaffoldState = bottomSheetScaffoldState, sheetContent = {
        PaymentScreenBottomSheet(bottomSheetScaffoldState = bottomSheetScaffoldState,
        ...
        Box {
            ...
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                Column(
                    ...
                    Image(painter = painterResource(id = R.drawable.img_login_tittle),
                        contentDescription = stringResource(id = R.string.content_description),
                        modifier = Modifier
                            .padding(top = 52.dp)
                            .width(92.dp)
                    ...
                    Text(modifier = Modifier
                        ...
                        lineHeight = 40.sp)
                    Text(text = stringResource(id = R.string.payment_tv_text_description),
                        modifier = Modifier
                            .fillMaxWidth()
                    ...
                    Card(modifier = Modifier
                        ...
                        .clickable(indication = null,
                            ...
                            changePaymentStatusApi(context,
                                homeViewModel,
                                mainActivity,
                                navHostController)
                        },
...
fun PaymentScreenBottomSheet(
    ...
    Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.Bottom) {
        Button(onClick = {
            ...
            Text(text = stringResource(id = R.string.payment_bs_subscribe_btn_text),
                style = MaterialTheme.typography.body2,
                fontWeight = FontWeight.W700,
                fontSize = 18.sp,
                color = Color.White,
...
private fun changePaymentStatusApi(
    ...
    homeViewModel.updatePaymentStatus(UpdatePaymentStatusRequest(
        user_id = userId,
    ))
    homeViewModel.updatePaymentStatusResponse.observe(mainActivity) {
        if (it != null) {
            handlePaymentStatusData(result = it,
                homeViewModel = homeViewModel,
                context = context,
                navHostController)
        }
