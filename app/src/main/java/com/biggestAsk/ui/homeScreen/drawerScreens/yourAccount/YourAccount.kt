...
fun YourAccountScreen(
    ...
    Log.d("TAG", "YourAccount: isEditable ${yourAccountViewModel.isEditable.value}")
            ...
            Column(
                ...
                Row(
                    ...
                    ConstraintLayout(
                        ...
                        if (yourAccountViewModel.surrogateImg == "") {
                            Card(
                                modifier = Modifier
                                    .width(88.dp)
                                    .height(88.dp)
                        ...
                        if (yourAccountViewModel.isEditable.value) {
                            Button(
                                onClick = {
                                    ...
                                    val image = yourAccountViewModel.uriPath?.let { convertImageMultiPart(it) }
