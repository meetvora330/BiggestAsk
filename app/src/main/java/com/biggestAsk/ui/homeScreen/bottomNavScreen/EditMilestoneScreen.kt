...
fun EditMilestoneScreen(
    ...
    val editMilestoneBottomSheetState =
    ...
    val launcher = rememberLauncherForActivityResult(
        ...
        if (uri != null) {
            ...
            if (editMilestoneViewModel.imageListIndex.value != -1) {
                ...
                editMilestoneViewModel.updateMilestoneImage(MultipartBody.Part.createFormData(
                    Constants.IMAGE_ID,
                    editMilestoneViewModel.imageList[latestIndex.value].id.toString()), image)
                editMilestoneViewModel.updateMilestoneImage.observe(homeActivity) {
                    if (it != null) {
                        handleUpdateImageData(result = it,
                            editMilestoneViewModel = editMilestoneViewModel,
                            context = context,
                            latestIndex.value)
                    }
                ...
                editMilestoneViewModel.imageList.add(EditMilestoneImageResponse("",
                    0,
                    "",
                    0,
                    "",
    ...
    if (!editMilestoneViewModel.isEditMilestoneDataLoaded.value) {
        BottomSheetScaffold(scaffoldState = editMilestoneBottomSheetState, sheetContent = {
            Column(modifier = Modifier
                ...
                Column(modifier = Modifier
                    ...
                    Text(modifier = Modifier
                        ...
                        style = MaterialTheme.typography.body2.copy(color = Color(0xFF7F7D7C),
                            fontWeight = FontWeight.W600,
                            fontSize = 14.sp,
                            lineHeight = 22.sp,
                    ...
                    TextField(modifier = Modifier
                        ...
                        placeholder = {
                            Text(text = stringResource(id = R.string.enter_tittle),
                    ...
                    TextField(modifier = Modifier
                        ...
                        .clickable(indication = null,
                            ...
                            datePickerDialog
                                ...
                                .setTextColor(ContextCompat.getColor(context, R.color.custom_blue))
                            datePickerDialog
                        ...
                        onClick = {
                            when {
                                TextUtils.isEmpty(editMilestoneViewModel.editMilestoneTittle.value) && TextUtils.isEmpty(
                                    editMilestoneViewModel.editMilestoneDate.value) || TextUtils.isEmpty(
                                    editMilestoneViewModel.editMilestoneTime.value) && TextUtils.isEmpty(
                                    editMilestoneViewModel.editMilestoneLocationB.value) -> {
                                        ...
                                        if (!isDateChecked) {
                                            ...
                                            if (localDateTime.trim().isNotEmpty()) {
                                                val updateMilestoneAnsInfoRequest =
                                                    UpdateMilestoneAnsInfoRequest(title = editMilestoneViewModel.editMilestoneTittle.value,
                                            ...
                                            editMilestoneViewModel.updateMilestoneAnsInfoResponse.observe(
                                                homeActivity) {
                                                if (it != null) {
                                                    handleUpdateMilestoneData(coroutineScope = coroutineScope,
                    ...
                    Column(modifier = Modifier
                        ...
                        Row(modifier = Modifier.fillMaxWidth()) {
                            if (editMilestoneViewModel.editMilestoneTitleImage.value.isEmpty()) {
                                ...
                                val painter =
                                    rememberImagePainter(editMilestoneViewModel.editMilestoneTitleImage.value,
                                        builder = {
                ...
                items(editMilestoneViewModel.imageList.size) { index ->
                    Box(modifier = Modifier
                        ...
                        Canvas(modifier = Modifier
                            .fillMaxWidth()
                            .height(190.dp)) {
                            drawRoundRect(color = Color(0xFFC6C4C2),
                                style = stroke,
                                ...
                                if (it) {
                                    if (Build.VERSION.SDK_INT < 28) {
                                        Image(modifier = Modifier.fillMaxWidth(),
                                            bitmap = MediaStore.Images.Media.getBitmap(context.contentResolver,
                                    ...
                                    val painter =
                                        rememberImagePainter(editMilestoneViewModel.imageList[index].image,
                                            builder = {
                                                placeholder(R.drawable.ic_baseline_place_holder_image_24)
                                            })
                                    Image(modifier = Modifier.fillMaxWidth(),
                                ...
                                Row(modifier = Modifier
                                    ...
                                    Button(modifier = Modifier
                                        ...
                                        Text(modifier = Modifier.wrapContentWidth(),
                                            ...
                                            style = MaterialTheme.typography.h1.copy(fontWeight = FontWeight.W900,
                                                color = Color.White,
                                                fontSize = 16.sp,
                                                lineHeight = 24.sp,
                                                textAlign = TextAlign.Center))
                                        Icon(modifier = Modifier.padding(start = 13.dp),
                ...
                item {
                    if (type == Constants.PARENT) {
                        if (editMilestoneViewModel.milestoneType.value == Constants.PARENT) {
                            ConstraintLayout(modifier = Modifier
                                ...
                                Text(modifier = Modifier
                                    ...
                                    style = MaterialTheme.typography.body2.copy(color = Color(
                                        0xFFC6C4C2), fontSize = 12.sp, lineHeight = 24.sp),
                                    textAlign = TextAlign.Center)
                                Button(modifier = Modifier
                                    .width(210.dp)
                                    .wrapContentHeight()
                        ...
                        ConstraintLayout(modifier = Modifier
                            ...
                            Text(modifier = Modifier
                                ...
                                text = stringResource(id = R.string.attach_photo_and_comment),
                                style = MaterialTheme.typography.body2.copy(color = Color(0xFFC6C4C2),
                                    fontSize = 12.sp,
                                    lineHeight = 24.sp),
                                textAlign = TextAlign.Center)
                            Button(modifier = Modifier
                    ...
                    if (type == Constants.PARENT && editMilestoneViewModel.surrogateNote.value != "") {
                        Column(modifier = Modifier
                            .fillMaxWidth()
                            .padding(top = 26.dp)) {
                            Text(text = stringResource(id = R.string.surrogate_note),
                                style = MaterialTheme.typography.body2.copy(color = Color.Black,
                                    fontWeight = FontWeight.W800,
                                    fontSize = 12.sp))
                            TextField(value = editMilestoneViewModel.surrogateNote.value,
                                onValueChange = {
                    ...
                    TextField(
                        ...
                        textStyle = MaterialTheme.typography.body2,
                        placeholder = {
                            Text(text = stringResource(id = R.string.write_notes_here),
                    ...
                    if (type == Constants.PARENT) {
                        Row(modifier = Modifier.padding(top = 10.dp)) {
                            CompositionLocalProvider(LocalMinimumTouchTargetEnforcement provides false) {
                                Checkbox(modifier = Modifier.padding(top = 18.dp,
                                    bottom = 10.dp,
                                    end = 5.dp),
                        ...
                        Button(modifier = Modifier.padding(top = 30.dp,
                            ...
                            onClick = {
                                if (!TextUtils.isEmpty(editMilestoneViewModel.addNewMilestoneNotes.value)) {
                                    if (type == Constants.PARENT) {
                                        editMilestoneViewModel.saveNote(SaveNoteRequest(milestone_id = milestoneId,
                                        ...
                                        editMilestoneViewModel.saveNote(SaveNoteRequest(milestone_id = milestoneId,
                                            ...
                                            type = type,
                                            share_note_with_partner = editMilestoneViewModel.checkBoxShareWithParents,
                                            surrogate_share_note_with_biggestask = editMilestoneViewModel.checkBoxShareWithBiggestAsk))
                                    }
                                    editMilestoneViewModel.saveNoteResponse.observe(homeActivity) {
                                        if (it != null) {
                                            handleSaveNoteData(result = it,
                                                editMilestoneViewModel = editMilestoneViewModel,
                                                context = context)
                                        }
                                    }
                            ...
                            elevation = ButtonDefaults.elevation(defaultElevation = 0.dp,
                                ...
                                hoveredElevation = 0.dp,
                                focusedElevation = 0.dp)) {
                            Text(text = stringResource(id = R.string.save_notes),
                                style = MaterialTheme.typography.body1.copy(fontSize = 16.sp,
                                    color = Color.White,
                                    lineHeight = 24.sp,
                                    fontWeight = FontWeight.W600))
                    ...
                    if (type == Constants.PARENT) {
                        if (editMilestoneViewModel.milestoneType.value == Constants.PARENT) {
                            Row(modifier = Modifier
                                ...
                                verticalAlignment = Alignment.CenterVertically,
                                horizontalArrangement = Arrangement.Center) {
                                Button(modifier = Modifier.width(218.dp),
                                    onClick = {
                                        val userId = PreferenceProvider(context).getIntValue(
                                            Constants.USER_ID,
                                            0)
                                        ...
                                        if (imageList.isEmpty()) {
                                            ...
                                            editMilestoneViewModel.storeMilestoneAns(images = imageList,
                                                user_id = MultipartBody.Part.createFormData(
                                                    Constants.USER_ID,
                                                    userId.toString()),
                                                type = MultipartBody.Part.createFormData(Constants.TYPE,
                                                    type),
                                            ...
                                            editMilestoneViewModel.updateMilestoneResponse.observe(
                                                homeActivity) {
                                                if (it != null) {
                                                    handleStoreMilestoneData(result = it,
                                                        editMilestoneViewModel = editMilestoneViewModel,
                                                        navHostController = navHostController,
                                                        milestoneId)
                                                }
                                    ...
                                    elevation = ButtonDefaults.elevation(defaultElevation = 0.dp,
                                        ...
                                        hoveredElevation = 0.dp,
                                        focusedElevation = 0.dp)) {
                                    Text(text = stringResource(id = R.string.update_milestone),
                                        style = MaterialTheme.typography.body2.copy(color = Color.White,
                                            fontWeight = FontWeight.W900,
                                            fontSize = 16.sp))
                            ...
                            Button(modifier = Modifier.width(218.dp),
                                onClick = {
                                    ...
                                    if (imageList.isEmpty()) {
                                        ...
                                        editMilestoneViewModel.storeMilestoneAns(images = imageList,
                                            user_id = MultipartBody.Part.createFormData(Constants.USER_ID,
                                                userId.toString()),
                                            type = MultipartBody.Part.createFormData(Constants.TYPE,
                                                type!!),
                                            milestone_id = MultipartBody.Part.createFormData(
    ...
    if (editMilestoneViewModel.isMilestoneDataUpdated.value || editMilestoneViewModel.isNoteSaved.value) {
        ProgressBarTransparentBackground(loadingText = if (editMilestoneViewModel.isMilestoneDataUpdated.value) stringResource(
            id = R.string.updating) else stringResource(id = R.string.saving))
    }
...
private fun getUpdatedMilestone(
    ...
    editMilestoneViewModel.getMilestoneDetails(EditMilestoneRequest(type = type!!,
        user_id = userId,
        milestone_id = milestoneId,
        partner_id = partner_id))
    editMilestoneViewModel.editMilestoneResponse.observe(homeActivity) {
        if (it != null) {
            handleEditMilestoneData(result = it,
                context = context,
                editMilestoneViewModel = editMilestoneViewModel)
        }
    }
...
private fun handleUpdateImageData(
    ...
    when (result) {
        ...
        is NetworkResult.Success -> {
            ...
            val tempData = editMilestoneViewModel.imageList.toList()
            editMilestoneViewModel.imageList.clear()
            editMilestoneViewModel.imageList.addAll(tempData)
        }
        is NetworkResult.Error -> {
        ...
        is NetworkResult.Success -> {
            ...
            if (!result.data.milestone[0].date.isNullOrBlank()) {
                ...
                if (localDate != null) {
                    ...
                    editMilestoneViewModel.milestoneDate.value = localDate
                } else {
                    editMilestoneViewModel.editMilestoneDate.value = ""
                ...
                if (localTime != null) {
                    ...
                    editMilestoneViewModel.milestoneTime.value = localTime
                } else {
                    editMilestoneViewModel.editMilestoneTime.value = ""
            ...
            if (result.data.milestone[0].milestone_image?.isNotBlank() == true) {
                editMilestoneViewModel.editMilestoneTitleImage.value =
                    result.data.milestone[0].milestone_image.toString()
            } else {
                editMilestoneViewModel.editMilestoneTitleImage.value = ""
            }
            if (type == Constants.PARENT) {
...
fun convertImageMultiPart(imagePath: String): MultipartBody.Part {
    ...
    return MultipartBody.Part.createFormData(Constants.IMAGE_ARRAY,
        file.name,
...
fun convertImageMultiPartSingle(imagePath: String): MultipartBody.Part {
    val file = File(imagePath)
    return MultipartBody.Part.createFormData(Constants.IMAGE,
        file.name,
        file.asRequestBody(Constants.IMAGE_LAUNCHER.toMediaTypeOrNull()))
}
...
private fun checkDate(
    ...
    if (selectedMilestoneIndex == 0) {
        ...
        if (dateDown != null) {
            downDate = changeLocalFormat(
                dateDown,
                Constants.DATE_FORMAT_UTC,
                Constants.SIMPLE_DATE_FORMAT).toString()
            val comparingDate = Date(downDate)
...
fun upDate(list: SnapshotStateList<Milestone>, selectedMilestoneIndex: Int): String? {
    if (selectedMilestoneIndex == 0) return null
    for (i in selectedMilestoneIndex - 1 downTo 0) {
        if (!list[i].date.isNullOrEmpty()) {
            return list[i].date
        }
    }
    return null
...
fun downDate(list: SnapshotStateList<Milestone>, selectedMilestoneIndex: Int): String? {
    for (i in selectedMilestoneIndex + 1 until list.size) {
        if (!list[i].date.isNullOrEmpty()) {
            return list[i].date
        }
    }
